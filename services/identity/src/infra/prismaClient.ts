 ...
 * which needs an Identity-shaped Prisma client but must not import
 * `@prisma/client` directly itself: this service's generated client lives
 * at services/identity/node_modules/@prisma/client (see schema.prisma's
