 ...
 * Prisma client but must not import it directly itself: this service's
 * generated client lives at services/catalog/generated/prisma-client
 * (see schema.prisma's `output`), a path only resolvable from inside this
 * service. Same shape as services/identity/src/infra/prismaClient.ts's
 * createPrismaClient.
 */
